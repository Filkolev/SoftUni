...
var circle = new shapeModule.Circle(0, 0, 12, "#00FF00");
console.log(circle.toString());

var rectangle = new shapeModule.Rectangle(0, 0, 2, 4, "AAA");
console.log(rectangle.toString());

var triangle = new shapeModule.Triangle(0, 0, 1, 1, 5, 8, "ABC");
console.log(triangle.toString());

var line = new shapeModule.Line(0, 0, 1, 1, "A");
console.log(line.toString());

var segment = new shapeModule.Segment(0, 1, 2, 3, "S");
